                        ...
                        var tab=option['p'],
                            ...
                            var reChechk=function(){
                                for(var i in elOptions){
                                    if(p===elOptions[i]['prop'] && t===elOptions[i]['type'] && tab===elOptions[i]['p'] && h===elOptions[i]['is_hover'] && (o===null || elOptions[i][o]===true) && r===elOptions[i]['is_responsive']){
                            ...
                            if(p==='background-image' && (t==='image' || t==='imageGradient')){
                                ...
                                if(elType==='row' || elType==='column'){
                                    ...
                                    t='margin';
                                    if(reChechk()===true){console.log(cacheGSProp[elType][id]);
                                        return cacheGSProp[elType][id];
                                    }
                                }
                            }
                    ...
                    recursiveLoop=function(data,type){
                        var getCustomCss = function (component, elementId, st) {
                            ...
                            setData=function(elType,element_id,styling){
                                ...
                                if ( styling != undefined && styling['builder_content'] !== undefined ) {
                                ...
                                for (var i in styles) {
                                    if(styles[i]!==null){
                                        ...
                                        if (type === 'expand' || type === 'multi' || type === 'group') {
                                            getStyles(styles[i].options,parent);
                                        }
                                        else if (type === 'tabs') {
                                            for (var j in styles[i].options) {
                                                var p= parent===undefined?j:parent;
